/**
 * @author Dawson Szarek Hashtable to store (char, binPath) pairs for Encoding
 */
public class EncodingTable {
	...
	/**
	 * Adds CharPathPair into the Table while setting its binPath to path.
	 */
	...
	/**
	 * Will return the CharPathPair if it is in the Table else return Null
	 */
	...
	/**
	 * Returns the Binary encoding path for char c if it is in the Table else return
	 * Null
	 */
